                    ...
                    <div class="flex space-x-4">
                        @if ($application->status === 'pending')
                            <form
                                ...
                                @csrf
                                <button type="submit"
                                    class="px-4 py-2 rounded-md text-sm font-medium btn-primary hover:opacity-90 transition">
                                    Approve
                                </button>
                            </form>
                            <form
                                ...
                                @csrf
                                <button type="submit"
                                    class="px-4 py-2 rounded-md text-sm font-medium btn-destructive hover:opacity-90 transition">
                                    Reject
                                </button>
                            </form>
                        @elseif ($application->status === 'approved')
                            <p>The application is accepted</p>
