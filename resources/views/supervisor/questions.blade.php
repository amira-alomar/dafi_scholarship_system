        ...
        <div class="bg-white rounded-lg shadow-sm overflow-hidden">
                    ...
                    <div class="p-6 hover:bg-gray-50 transition-colors duration-150">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <span
                                    class="inline-block mt-1 px-2 py-1 text-xs font-medium rounded-full bg-gray-100 text-gray-600">
            ...
            <div class="p-6 bg-gray-50 border-t border-gray-200">
                ...
                <form action="{{ route('questions.store') }}" method="POST" class="space-y-4">
                    ...
                    <div>
                        <label for="question_text" class="block text-sm font-medium text-gray-700 mb-1">Question
                            Text</label>
                        <input type="text" id="question_text" name="question_text" placeholder="Enter new question"
                            required
                    ...
                    <div>
                        <label for="question_type" class="block text-sm font-medium text-gray-700 mb-1">Question
                            Type</label>
            ...
            @foreach ($documents as $doc)
                <div class="p-4 flex justify-between items-center hover:bg-gray-50">
                    <div>
                        ...
                        <span
                            class="ml-2 px-2 py-1 text-xs rounded-full bg-gray-100 text-gray-600">{{ strtoupper($doc->type) }}</span>
                    </div>
                    <div class="flex space-x-2">
                        <button
                            onclick="openEditDoc({{ $doc->id }}, '{{ $doc->name }}', '{{ $doc->type }}')"
        ...
        <form action="{{ route('documents.store') }}" method="POST" class="space-y-4">
            ...
            <div class="flex space-x-4">
                ...
                <select name="type" required
                    class="rounded-md border-gray-300 shadow-sm focus:ring focus:ring-red-200">
