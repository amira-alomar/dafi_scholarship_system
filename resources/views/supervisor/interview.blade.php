...
<body class="bg-gray-50 font-sans">
    <!-- Top Navigation Bar -->
    <nav class="bg-[#313e53] text-white shadow-md">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16 items-center">
                <div class="flex items-center">
                    <span class="text-xl font-semibold">Interview Manager</span>
                </div>
                {{-- <div>
                    <a href="{{ route('dashboard') }}" class="bg-[#e05252] hover:bg-[#c04a4a] text-white px-4 py-2 rounded-md text-sm font-medium transition-colors duration-200">
                        Back to Dashboard
                    </a>
                </div> --}}
            </div>
                        ...
                        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                            ...
                            <div class="flex-1">
                                ...
                                <p class="text-gray-600 mt-1">
                                    <span class="font-medium">Email:</span> {{ $progress->application->user->email }}
                                </p>
                                <div class="mt-2">
                                    <span
                            ...
                            <div class="flex flex-col sm:flex-row gap-3">
                                @if ($progress->application->stageProgress->isNotEmpty())
                                    <button class="px-4 py-2 bg-gray-200 text-gray-600 rounded-md cursor-not-allowed"
                                        disabled>
                                        Scheduled
                                    </button>
                                @else
                                    <!-- بدل الفورم القديم اللي فيه input date -->
                                    <form
