                    ...
                    <div class="profile-pic-container">
                        <form action="{{ route('student.profile.update') }}" method="POST"
                            ...
                            <div class="profile-pic-upload">
                                ...
                                <input type="file" name="image" id="profile-upload" accept="image/*" class="hidden"
                                    onchange="document.getElementById('image-submit').click()">
                            </div>
                        ...
                        <form action="{{ route('student.profile.update') }}" method="POST">
                            ...
                            <div class="profile-grid">
                                <div class="profile-info-item">
                                    ...
                                    <div class="profile-info-value">{{ auth()->user()->fname }}
                                        {{ auth()->user()->lname }}</div>
                                ...
                                <div class="profile-info-item">
                                    ...
                                    <div class="profile-info-value">
                                        {{ \Carbon\Carbon::parse(auth()->user()->birthdate)->format('M d, Y') }}</div>
                                    <input type="date" class="profile-info-input" name="birthdate"
                                ...
                                <div class="profile-info-item">
                                    ...
                                    <input type="tel" class="profile-info-input" name="phone_number"
                        ...
                        <form action="{{ route('student.profile.update') }}" method="POST">
                            ...
                            <div class="profile-grid">
                                ...
                                <div class="profile-info-item">
                                    ...
                                    <input type="text" class="profile-info-input" name="universityID"
                                        value="{{ $universityID ?? 'Not Set' }}">
                                </div>
                                <div class="profile-info-item">
                    ...
                    <div class="profile-card">
                        <div class="profile-section-title flex items-center justify-between">
                            ...
                            <button class="btn btn-sm btn-primary"
                                onclick="document.getElementById('add-skill-modal').classList.remove('hidden')">
                    ...
                    <div class="bg-white p-6 rounded-lg w-96 shadow-xl">
                        ...
                        <form method="POST" action="{{ route('profile.skills.add') }}">
                            ...
                            <div class="flex justify-end gap-2">
                                <button type="button"
                                    onclick="document.getElementById('add-skill-modal').classList.add('hidden')"
