                    ...
                    <div class="content-column">
                                    ...
                                    <div class="personal-details">
                                        <div class="detail-item">
                                            ...
                                            <div>
                                                ...
                                                <div class="detail-value">
                                                    <span>{{ optional(auth()->user())->fname ?? 'Guest' }}</span>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="detail-item">
                                            ...
                                            <div>
                                                ...
                                                <div class="detail-value">
                                                    <span>{{ optional(auth()->user())->email ?? 'Not Available' }}</span>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="detail-item">
                                            ...
                                            <div>
                                                ...
                                                <div class="detail-value"><span>{{ $university ?? 'Not Set' }}</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="academic-details">
                                        ...
                                        <div class="detail-item">
                                            ...
                                            <div>
                                                ...
                                                <div class="detail-value"><span>{{ $gpa ?? 'Not Set' }}</span> / 4.00
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="gpa-container">
                                            ...
                                            <div class="gpa-chart">
                                                <div class="gpa-progress" style="width: {{ ($gpa ?? 0) * 25 }}%">
                                                </div>
                                            </div>
                                            <div class="gpa-scale">
                                                <span>0.00</span>
                            ...
                            <div class="card-content">
                                <div class="card-header">
                                    ...
                                    <button class="icon-button"
                                        onclick="document.getElementById('goal-form').style.display='block'">
                                    ...
                                    @foreach ($goals as $index => $goal)
                                        <div class="goal-card">
                                            <div class="goal-header">
                                                ...
                                                <div class="goal-date">Due: {{ $goal->due_date->format('M d, Y') }}
                                                </div>
                                            ...
                                            <div class="completion-bar">
                                                <div class="completion-progress"
                                                    style="width: {{ $goal->progress }}%; background-color: {{ $goal->completion_color }};">
                                                </div>
                                            </div>
                                            <div class="goal-stats">
                                                <div class="goal-progress">Progress:{{ $goal->progress }}%</div>
                                                <div class="days-remaining">{{ $goal->days_remaining }} days remaining
                                                </div>
                                            </div>
                                            <div style="display: flex; gap: 10px; margin-top: 10px;">
                                                <!-- Mark as Completed -->
                                                <form method="POST"
                                                    action="{{ route('goals.update', $goal->goalID) }}">
                                                    @csrf
                                                    @method('PUT')
                                                    <input type="range" name="progress" min="0"
                                                        max="100" value="{{ $goal->progress }}">
                                                    <button type="submit" class="primary-button">Update
                                                        Progress</button>
                                                </form>

                                                <!-- Delete Goal -->
                                                <form method="POST"
                                                    action="{{ route('goals.destroy', $goal->goalID) }}">
                                                    @csrf
                                                    @method('DELETE')
                        ...
                        <div class="sidebar-column">
                            ...
                            <div class="card scale-hover">
                                <div class="card-content">
                                    ...
                                    <form class="training-form" action="{{ route('trainings.store') }}"
                                        method="POST" enctype="multipart/form-data">
                                        @csrf
                                        <div class="form-group">
                                            <label for="training-name" class="form-label">Training Name</label>
                                            <input id="training-name" type="text" class="form-input"
                                            ...
                                            <div class="file-upload-container">
                                                <label for="training-file" class="file-upload-area">
                                                    <div class="upload-content">
                                                        ...
                                                        <p class="upload-text">
                                                            <span class="upload-bold">Click to upload</span> or drag
                                                            and drop
                                                        </p>
                                                        <p class="upload-formats">PDF, PNG, JPG or JPEG (MAX. 2MB)</p>
                                                    </div>
                                                    <input id="training-file" type="file" class="hidden-input"
                                                        accept=".pdf,.png,.jpg,.jpeg" name="certificate">
                                                </label>
                                            </div>
                                        </div>
                        ...
                        <div class="card scale-hover">
                            <div class="card-content">
                                ...
                                <form class="volunteering-form" action="{{ route('volunteerings.store') }}"
                                    method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class="form-group">
                                        <label for="volunteering-name" class="form-label">Volunteering Name</label>
                                        <input id="volunteering-name" type="text" class="form-input"
                                            placeholder="Enter volunteering name" name="name">
                                    </div>
                                    <div class="form-group">
                                        <label for="volunteering-name" class="form-label">Volunteering hours </label>
                                        <input id="volunteering-name" type="text" class="form-input"
                                            placeholder="Enter volunteering hours" name="total_hours">
                                    </div>
                                        ...
                                        <div class="file-upload-container">
                                            <label for="volunteering-file" class="file-upload-area">
                                                <div class="upload-content">
                                                    <i class="bx bx-upload upload-icon"></i>
                                                    <p class="upload-text">
                                                        <span class="upload-bold">Click to upload</span> or drag and
                                                        drop
                                                    </p>
                                                    <p class="upload-formats">PDF, PNG, JPG or JPEG (MAX. 2MB)</p>
                                                </div>
                                                <input id="volunteering-file" type="file" class="hidden-input"
                                                    accept=".pdf,.png,.jpg,.jpeg" name="certificate">
                                            </label>
                                        </div>
                                    </div>
                                ...
                                <div class="card-content">
                                    ...
                                    <div class="certificates-container">
                                        @foreach ($trainings as $index => $training)
                                            <div
                                                class="certificate-card training-certificate {{ $index >= 3 ? 'hidden-certificate' : '' }}">
                                                <div class="certificate-content">
                                                    ...
                                                    <div class="certificate-details">
                                                        ...
                                                        <p class="certificate-date">Added:
                                                            {{ $training->created_at->format('M d, Y') }}</p>
                                                    </div>
                                        ...
                                        <div class="view-all">
                                            <a href="#" id="toggleTrainingCertificates"
                                                class="link-button">View All Certificates</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="card-content">
                                        ...
                                        <div class="certificates-container">
                                            @foreach ($volunteerings as $index => $volunteering)
                                                <div
                                                    class="certificate-card volunteering-certificate {{ $index >= 3 ? 'hidden-certificate' : '' }}">
                                                    <div class="certificate-content">
                                                        <div class="certificate-icon">
                                                            <i class="bx bx-award accent-icon"></i>
                                                        </div>
                                                        <div class="certificate-details">
                                                            <h3 class="certificate-title">{{ $volunteering->name }}
                                                            </h3>
                                                        ...
                                                        <a href="{{ asset('storage/' . $volunteering->certificate) }}"
                                                            target="_blank" class="certificate-link">View
                                                            Certificate</a>
                                            ...
                                            <div class="view-all">
                                                <a href="#" id="toggleVolunteeringCertificatess"
                                                    class="link-button">View All Certificates</a>
                                            </div>
                                        </div>
                                    </div>
